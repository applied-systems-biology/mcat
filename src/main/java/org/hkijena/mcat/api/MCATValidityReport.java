...
public class MCATValidityReport {
    ...
    public MCATValidityReport(Object target, String category, Entry.Type type, String message) {
        this.report(target, category, type, message);
    }

    public MCATValidityReport(Object target, String category, boolean isValid, String message) {
     ...
     * @param category
     */
    public void merge(MCATValidityReport subreport, String... category) {
