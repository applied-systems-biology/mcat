 ...
 */
public class MCATIndividualClusterDataInterface implements MCATDataInterface {
    ...
    public MCATIndividualClusterDataInterface() {

    }

    public MCATIndividualClusterDataInterface(MCATIndividualClusterDataInterface other) {
